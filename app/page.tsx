      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a href="tel:4509876543" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 border-2 border-gray-700 text-white px-8 py-4 rounded-full text-lg font-semibold hover:border-amber-400 hover:text-amber-400 transition-all">
    ...
    <section className="py-24 bg-gradient-to-br from-amber-500 via-orange-500 to-red-500 relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a href="tel:4509876543" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-white/20 backdrop-blur text-gray-900 px-8 py-4 rounded-full text-lg font-bold border-2 border-gray-900/20 hover:bg-white/30 transition-all">
            (450) 987-6543
          </a>
        </div>
      </div>
        ...
        <div>
          ...
          <div className="mt-10 space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="font-semibold text-white text-lg">(450) 987-6543</div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="font-semibold text-white text-lg">info@detailingprolaurentides.ca</div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="font-semibold text-white text-lg">890, boul. Curé-Labelle, Blainville</div>
